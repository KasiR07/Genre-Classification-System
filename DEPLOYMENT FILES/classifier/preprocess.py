...
def save_mfcc(dataset_path, json_path, option=DATA_OPTION): #Save the mfccs or melspectrograms in a json file. Also split each sample up in to chunks. option: can be either "mfcc" or "melspectrogram".
